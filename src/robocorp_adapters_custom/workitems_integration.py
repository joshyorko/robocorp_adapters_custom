...
def initialize_adapter() -> BaseAdapter:
    ...
    """
    # Import adapter configuration utilities from the package
    try:
        from .config import get_adapter_config, validate_adapter_config
        ...
        raise ImportError(
            "Required module 'config' not found in package. "
            "This is a package installation issue."
        ) from e
