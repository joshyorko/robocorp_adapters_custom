...
try:
    from robocorp.workitems import _adapters as robocorp_adapters
...
sys.modules.setdefault("robocorp.workitems._adapters._support", _support_module)

# Also provide fallback mappings for our local modules
sys.modules.setdefault("robocorp.workitems._types", _types_module)
sys.modules.setdefault("robocorp.workitems._utils", _utils_module)
...
sys.modules.setdefault("robocorp.workitems._adapters._sqlite", _sqlite_module)

SQLiteAdapter = _sqlite_module.SQLiteAdapter
if robocorp_adapters is not None:
    robocorp_adapters.sqlite = SQLiteAdapter
...
try:
    ...
    sys.modules.setdefault("robocorp.workitems._adapters._redis", _redis_module)
    RedisAdapter = _redis_module.RedisAdapter
    if robocorp_adapters is not None:
        robocorp_adapters.redis = RedisAdapter
...
try:
    ...
    sys.modules.setdefault("robocorp.workitems._adapters._docdb", _docdb_module)
